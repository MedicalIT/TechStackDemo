...
interface KnockoutStatic {
    ...
    toJS<T>(viewModel: KnockoutObservable<T>): T;
...
interface KnockoutComponents {
    ...
    //Condensed method
    //register(componentName: string, config: KnockoutComponentRegisterConfig): void;
    //register(componentName: string, config: KnockoutComponentRegisterAMD): void;
    
    //Expand so intellisense popups work better :)
    register(componentName: string, config: {
                synchronous?: boolean;
                template: string | { 
...
interface KnockoutComponentRegisterConfig {
    synchronous?: boolean;
    template: KnockoutComponentTemplate | string;
    viewModel: ((params: any)=> any) | KnockoutComponentConfigViewModel;
}
