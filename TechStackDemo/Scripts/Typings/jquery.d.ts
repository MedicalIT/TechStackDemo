...
interface JQueryStatic {
    ...
    when<T1, T2>(deferred1: T1|JQueryPromise<T1>, deferred2: T2|JQueryPromise<T2>): JQueryPromise<any>;
    when<T1, T2, T3>(deferred1: T1|JQueryPromise<T1>, deferred2: T2|JQueryPromise<T2>, deferred3: T3|JQueryPromise<T3>): JQueryPromise<any>;
    when<T1, T2, T3, T4>(deferred1: T1|JQueryPromise<T1>, deferred2: T2|JQueryPromise<T2>, deferred3: T3|JQueryPromise<T3>, deferred4: T4|JQueryPromise<T4>): JQueryPromise<any>;
    
    when(...deferreds: Array<any|JQueryPromise<any>>): JQueryPromise<void>;
