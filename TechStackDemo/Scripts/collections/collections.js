...
(function (collections) {
    ...
    */
    ...
    var Dictionary = (function () {
         ...
         */
        function Dictionary(toStrFunction, initialData, initialDataKeyExtractor) {
            var _this = this;
            this.table = {};
            this.nElements = 0;
            ...
            if (initialDataKeyExtractor && initialData) {
                initialData.forEach(function (d) {
                    _this.setValue(initialDataKeyExtractor(d), d);
                });
            }
            else if (initialData) {
                initialData.forEach(function (keyValue) { return _this.setValue(keyValue.key, keyValue.value); });
            }
        }
        /**
        ...
        */
         ...
         */
        Dictionary.prototype.getOrAddValue = function (key, factory, ifExists) {
    ...
    var Set = (function () {
         ...
         */
        function Set(toStringFunction, initialData) {
            this.dictionary = new Dictionary(toStringFunction, initialData, initialData && (function (x) { return x; }));
        }
        /**
